...
# Check if the player has at least 'amount' of an item.
...
# Get all items as an array of dictionaries: [{item_id: String, count: int}, ...]
...
# Optional: Clear the inventory (useful for debugging or new game)
func clear():
	items.clear()
