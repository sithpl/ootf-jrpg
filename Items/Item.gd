...
static func register_items():
	...
	ALL_ITEMS["old_sword"].bonuses    = {"attack": 2}
	...
	ALL_ITEMS["long_stick"]            = Item.new().update("long_stick", "Long Stick", 75, "That's a nice stick.", "M.Hand")
	ALL_ITEMS["long_stick"].bonuses    = {"attack": 1, "magic": 2}
